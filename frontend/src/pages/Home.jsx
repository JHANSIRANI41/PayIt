  ...
  return (
    <div className="h-screen flex flex-col">
      ...
      <main className="flex-grow bg-slate-300 flex flex-col justify-center items-center text-center px-4 ">
        <div className=" text-black-600 text-center pb-10">
  
  <h1 className="text-5xl font-bold">
     Fast<span className="text-blue-600">.</span>
     Simple<span className="text-blue-600">.</span>
      PayIt
  </h1>
      ...
      <footer className="w-full bg-white py-4 flex justify-center items-center shadow-inner">
        <div className="text-sm text-blue-500">
          © 2025 PayIt App. All rights reserved.
        </div>
      </footer>
    </div>
  );
